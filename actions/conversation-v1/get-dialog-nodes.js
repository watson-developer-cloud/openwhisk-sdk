 ...
 * @param {string} [params.sort] - Sorts the response according to the value of the specified
 * property, in ascending or descending order.
 * @param {string} [params.cursor] - A token identifying the last value from
...
function main(params) {
  return new Promise((resolve, reject) => {
    ...
    service.getDialogNodes(params, (err, response) => {
      if (err) {
        reject(err.message);
      } else {
        resolve(response);
