 ...
 * @param {CreateIntent[]} [params.intents] - An array of objects defining
 * the intents for the workspace.
 * @param {CreateEntity[]} [params.entities] - An array of objects defining
 * the entities for the workspace.
 * @param {CreateDialogNode[]} [params.dialog_nodes] - An array of objects defining
