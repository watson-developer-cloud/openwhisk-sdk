 ...
 * @param {string[]} params.collection_ids - A comma-separated list of collection IDs
 ...
 * For example, if the total number of results that are returned is 10, and
 * the offset is 8, it returns the last two results.
...
function main(params) {
  return new Promise((resolve, reject) => {
    ...
    service.query(params, (err, response) => {
      if (err) {
        reject(err.message);
      } else {
        resolve(response);
