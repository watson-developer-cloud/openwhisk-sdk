...
| [create-example](https://www.ibm.com/watson/developercloud/conversation/api/v1/curl.html?curl#create-example) | action |  username, password,  iam_access_token, iam_apikey, iam_url,  headers, headers[X-Watson-Learning-Opt-Out], url,    workspace_id,     intent,    text, mentions,  | Create user input example |
...
| [update-example](https://www.ibm.com/watson/developercloud/conversation/api/v1/curl.html?curl#update-example) | action |  username, password,  iam_access_token, iam_apikey, iam_url,  headers, headers[X-Watson-Learning-Opt-Out], url,    workspace_id,     intent,     text,    new_text, new_mentions,  | Update user input example |
...
| [list-mentions](https://www.ibm.com/watson/developercloud/conversation/api/v1/curl.html?curl#list-mentions) | action |  username, password,  iam_access_token, iam_apikey, iam_url,  headers, headers[X-Watson-Learning-Opt-Out], url,    workspace_id,     entity,     export,     include_audit,  | List entity mentions |
