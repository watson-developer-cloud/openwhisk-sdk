 ...
 * @param {string} [params.size] - Size that the environment should be increased to. Environment size cannot be modified
 * when using a Lite plan. Environment size can only increased and not decreased.
