...
let updateDialogNode = require('../../../packages/conversation-v1/actions/update-dialog-node');

let ow;
let credentials;
let payload = {
  dialog_node: 'example_node',
  new_dialog_node: 'example_node',
...
before(() => {
  if (process.env.TEST_OPENWHISK && auth) {
    ...
    updateDialogNode = adapt(
      updateDialogNode,
      'conversation-v1/update-dialog-node',
      ow
    );
