...
let getCollection = require('../../../actions/discovery-v1/get-collection');
...
before(() => {
  if (process.env.TEST_OPENWHISK) {
    ...
    getCollection = adapt(getCollection, 'discovery-v1/get-collection', ow);
    ...
    beforeEach(() => {
      nock('https://gateway.watsonplatform.net/discovery')
        .get(`/api/v1/environments/${payload.environment_id}/collections/${payload.collection_id}`)
        .query({
