...
let listTrainingExamples = require('../../../actions/discovery-v1/list-training-examples');
  ...
  if (process.env.TEST_OPENWHISK) {
    ...
    beforeEach(() => {
      nock('https://gateway.watsonplatform.net/discovery')
        .get(`/api/v1/environments/${payload.environment_id}/collections/${payload.collection_id}/training_data/${payload.query_id}/examples`)
        .query({
